---
title: Known Issues
description: Known problems with Essentials and how to work around them.
---
...
try using a **VPN** and if that doesn't work then report the issue to https://github.com/Compourri/essentials/issues

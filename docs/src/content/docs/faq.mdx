...
description: Common questions about installing, running, and troubleshooting Essentials.
---
...
No. Windows 10 is no longer supported by Essentials because it reached the end of support on **October 14, 2025**. Essentials is focused on Windows 11.
...
- Run only from the [official source](https://github.com/Compourri/essentials/)
...
1. **Use the direct GitHub link**:
   ...
   ```powershell
   irm https://github.com/Compourri/essentials/releases/latest/download/Essentials.ps1 | iex
   ```
...
### How does Essentials install applications?

Essentials uses Windows Package Manager (WinGet) and Chocolatey to automate installations. It downloads applications from official sources and installs them silently without bloatware.
...
- Some packages installed by Essentials (AppX/MSIX) include removal helpers; check the app entry or use Essentials's remove helpers when available.

### Will installed apps auto-update?

Applications with built-in update mechanisms will auto-update. You can also update them via WinGet/Chocolatey commands or through Essentials's "Upgrade Selected" feature.
...
### Essentials won't open after running the command
...
### My antivirus flags Essentials as malicious

This is a false positive. Essentials makes system changes that antivirus programs may flag. The code is open source and audited. Add an exception if needed.
...
### Can I run Essentials on Windows Server?

Yes, Essentials works on Windows Server editions, though some features may not be applicable or may behave differently.

### Does Essentials work with Windows LTSC?

Yes, Essentials works with Windows 10/11 LTSC editions. Some applications may not be available depending on your configuration.
...
### Can I contribute to Essentials?
...
### Does Essentials collect any data?

No, Essentials itself doesn't collect or transmit any user data. It's a local PowerShell script.
...
### Will Essentials make my PC faster?

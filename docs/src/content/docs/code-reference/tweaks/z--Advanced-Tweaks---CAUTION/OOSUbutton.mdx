...
:::note
This page is generated from [`functions/public/Invoke-WPFOOSU.ps1`](https://github.com/Compourri/essentials/blob/main/functions/public/Invoke-WPFOOSU.ps1). Do not edit this page directly.
:::

---
title: User Guide
description: Overview of the Essentials User Guide — installing apps, applying tweaks, running fixes, and managing updates.
sidebar:
  order: 0
---
...
Essentials (Chris Titus Tech's Windows Utility) is a comprehensive PowerShell-based tool that helps you:
...
## Who Should Use Essentials?

Essentials is designed for:
...
1. **[Getting Started](/guides/getting-started/)** - Learn how to launch Essentials and understand the basics.
...
Automate Essentials configurations for:
- Multiple PC setups
...
Want to help improve Essentials?
...
<YouTubeEmbed id="6UQZ5oQg8XA" title="Essentials overview" />
...
**[Getting Started](/guides/getting-started/)** — Learn how to use Essentials.

...
heroBadges:
  - src: https://img.shields.io/github/v/release/Compourri/essentials?color=%230567ff&label=Latest%20Release&style=for-the-badge
    alt: Latest release
    href: https://github.com/Compourri/essentials/releases/latest
  - src: https://img.shields.io/github/downloads/Compourri/essentials/winutil.ps1?label=Total%20Downloads&style=for-the-badge
    alt: Total downloads
...
hero:
  ...
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/Compourri/essentials
      icon: external
      variant: secondary
head:
  - tag: meta
    attrs:
      property: og:title
      content: Documentation | Essentials
  - tag: meta
    attrs:
      name: twitter:title
      content: Documentation | Essentials
    ...
    content: |
      {
        ...
        "name": "Essentials",
        "description": "Chris Titus Tech's Windows Utility — install apps, apply tweaks, run fixes, and manage Windows from one place.",
        "url": "https://compourri.github.io/essentials/",
        "downloadUrl": "https://github.com/Compourri/essentials",
...
{/* Problem section: pain points Essentials solves. */}
...
{/* Solution grid: how Essentials addresses each problem above. */}
<section class="wu-section">
	<div class="wu-section-inner">
		<div class="wu-section-head">
			<h2>Essentials puts a real control panel on top of Windows</h2>
	...
	<div class="wu-section-inner">
		...
		<div class="wu-feature-grid">
			<CornerCard icon="padlock" title="Nothing phones home">
				Essentials doesn't collect or transmit anything. It's a script that runs, makes the changes you selected, and exits.
			</CornerCard>
			...
			<CornerCard icon="server" title="Automation-friendly">
				Drive Essentials unattended with config files and parameters for repeatable rollouts across machines.
			</CornerCard>
	...
	<div class="wu-section-inner">
		...
		<div class="wu-timeline">
			...
			<div class="wu-timeline-step">
				...
				<Code code={'irm "https://compourri.co.za/essentials" | iex'} lang="powershell" />
			</div>
			<div class="wu-timeline-step">
...
<section class="wu-section wu-section--tint">
	<div class="wu-section-inner wu-text-narrow">
		<div class="wu-section-head wu-align-left">
			...
			<p>Registry edits and PowerShell one-liners work. Essentials makes them repeatable.</p>
		</div>
...
<section class="wu-section">
	<div class="wu-section-inner wu-text-narrow wu-cta">
		...
		<div class="wu-btn-row">
			...
			<a class="wu-btn wu-btn-secondary" href="https://github.com/Compourri/essentials">
				<Icon name="github" />
				{' View on GitHub'}
			</a>
		</div>

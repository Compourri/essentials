...
If you run Essentials and get an error like:
...
If you run Essentials and get the error:

`"Essentials is unable to run on your system. PowerShell execution is restricted by security policies"`

this means that your PowerShell session is in **Constrained Language Mode**, which prevents Essentials from running.

...
Software Essentials provides three update modes so you can choose how aggressively Windows Update is managed on your system:
...
{{< image src="images/updates-tab-new" alt="Updates tab in Software Essentials" >}}
...
- **Notes**: This removes custom update settings previously applied by Software Essentials. If update errors continue, use the reset option in the **Config** tab to restore Microsoft Update services to their default state.

...
This page maps to the **Config** tab in Essentials. Some actions complete immediately, while others may prompt, download files from Microsoft, or require a restart before the change is fully available.
...
Open old-school Windows panels directly from Essentials. Available panels include:

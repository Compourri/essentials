...
Essentials is a PowerShell-based Windows utility with a WPF (Windows Presentation Foundation) GUI. This document explains the architecture, code structure, and how different components work together.
...
The **Win11 Creator** is a specialized subsystem within Essentials that creates customized Windows 11 ISOs. It operates independently from the main package installation and tweak system.
...
4. Users download via `irm compourri.co.za/essentials`

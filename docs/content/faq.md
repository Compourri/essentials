...
No. Windows 10 is no longer supported by Essentials because it reached the end of support on **October 14, 2025**.
Essentials is focused on Windows 11.

### How do I uninstall Essentials?
You do not need to uninstall Essentials. Because it runs as a PowerShell script, it is loaded into memory only while it is open. Once you close it, it is removed from memory and does not remain installed on your system.

### Is Essentials safe to use?
Yes, Essentials is open source, and the code is publicly available on GitHub. Thousands of users run it daily. However, like any system modification tool, you should:
...
### Do I need to keep running Essentials?
No. Once you've applied tweaks or installed applications, you can close Essentials. Changes persist after closing. You only need to run Essentials again when you want to make additional changes or undo tweaks.

### Does Essentials require internet access?
...
### How often is Essentials updated?
Essentials is actively maintained with frequent updates. New features, bug fixes, and application additions are released regularly. The script auto-downloads the latest version each time you run it.

## Installation & Running

### How do I run Essentials?
1. Open PowerShell as Administrator
2. Run: `irm "https://compourri.co.za/essentials" | iex`
3. Wait for the GUI to appear

### Why do I need Administrator rights?
Essentials makes system-level changes (registry edits, service modifications, software installation) that require elevated permissions. Without admin rights, most features won't work.

### The script won't download. What do I do?
Try these solutions in order:

1. **Use the direct download link**:
   ```powershell
...
Currently, Essentials uses predefined presets (Standard, Minimal). Custom presets aren't directly supported in the GUI, but you can script your preferred configuration.
...
### Can I uninstall applications through Essentials?
Essentials primarily focuses on installing and managing applications rather than providing a full GUI for uninstalling every program. To remove applications you can:
...
- Some packages installed by Essentials (AppX/MSIX) include removal helpers; check the app entry or use Essentials' remove helpers when available.
...
### Can I use Essentials in a corporate/enterprise environment?
...
### How do I automate Essentials for multiple PCs?
...
### How much RAM does Essentials use?
Essentials itself uses about 50-100 MB while running. Once closed, it is removed from memory.

function Invoke-WinUtilInstallPSProfile {
    ...
    Invoke-WPFRunspace -ArgumentList $PROFILE -DebugPreference $DebugPreference -ScriptBlock {
        ...
        function Invoke-PSSetup {
            # Define the URL used to download Compourri PowerShell profile.
            ...
            # Download Compourri PowerShell profile to the 'TEMP' folder.
            Invoke-RestMethod $url -OutFile "$env:TEMP/Microsoft.PowerShell_profile.ps1"

            # Get the file hash for Compourri PowerShell profile.
            $NewHash = Get-FileHash "$env:TEMP/Microsoft.PowerShell_profile.ps1"

            # Store the file hash of Compourri PowerShell profile.
            ...
            if ($NewHash.Hash -ne $OldHash.Hash) {
                ...
                # Let the user know Compourri PowerShell profile is being installed.
                ...
                # Let the user know Compourri PowerShell profile has been installed successfully.
                Write-Host "Profile has been installed. Please restart your shell to reflect the changes!" -ForegroundColor Magenta

                # Let the user know Compourri PowerShell profile has been setup successfully.
                Write-Host "===> Finished Profile Setup <===" -ForegroundColor Yellow
            } else {
                # Let the user know Compourri PowerShell profile is already fully up-to-date.
        ...
        if (Get-Command "pwsh" -ErrorAction SilentlyContinue) {
            ...
            if ($PSVersionTable.PSVersion.Major -ge 7) {
                # Invoke the PowerShell Profile setup script to install Compourri PowerShell Profile.
                Invoke-PSSetup
            } else {

...
Software Essentialsmust be run in Admin mode because it performs system-wide tweaks. To achieve this, run PowerShell as an administrator. Here are a few ways to do it:
...
### [Software Essentials Official Documentation](https://christitustech.github.io/winutil/)
...
Thanks a lot for spending your time helping Software Essentialsgrow. Thanks a lot! Keep rocking 🍻.
